...
class Category extends Model
{
     ...
     */
    public $table = 'lx_portfolio_categories';
    public $rules = [
            'name' => 'required',
            'slug' => 'required|between:3,64|unique:lx_portfolio_categories',
            'code' => 'unique:lx_portfolio_categories',
        ];

    protected $guarded = [];

    public $belongsToMany = [
        'posts' => ['Lx\Portfolio\Models\Post', 'table' => 'lx_portfolio_posts_categories', 'order' => 'published_at desc', 'scope' => 'isPublished']
    ];
